        ...
        <Card className="shadow-2xl bg-white/10 backdrop-blur-md border-gray-800">
          ...
          <CardContent>
            ...
            <div className="mt-4 flex space-x-2">
              <Button variant="outline" className="w-full bg-white hover:bg-gray-100" onClick={() => toast.info('Google login not implemented')}>
              ...
              <Button variant="outline" className="w-full bg-white hover:bg-gray-100" onClick={() => toast.info('GitHub login not implemented')}>
